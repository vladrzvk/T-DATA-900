...
![alt text]("Spark master UI")

### Spark Worker 1

http://localhost:9091/

![alt text]( "Spark worker 1 UI")

### Spark Worker 2

http://localhost:9092/

![alt text]( "Spark worker 2 UI")
...
Thanks to marcovillarreal
cf : https://medium.com/@marcovillarreal_40011/creating-a-spark-standalone-cluster-with-docker-and-docker-compose-ba9d743a157f